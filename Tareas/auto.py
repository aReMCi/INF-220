...
class Automovil:
    ...
    def __init__(
        self, power="Apagado", estado="Parado", velocidad=0, marcha=None, direccion=None
    ):
        self.power = power
        self.estado = estado
    ...
    def acelerar(self, velocidad, direccion):
        if (self.get_power() == "Encendido") and (self.get_marcha() == "D"):
            ...
            print(
                f"El automovil acelera a {self.get_velocidad()} km/h en direccion {self.get_direccion()}"
            )
